...
const clearCartBtn = _(".clear-cart");
const cartDOM = _(".cart");
const cartOverlay = _(".cart-overlay");
const cartItems = _(".cart-items");
const cartTotal = _(".cart-total");
const cartContent = _(".cart-content");
const productsDOM = _(".products-center");
const cartLeft = _(".cart-left");
// cart
let cart = [];
// buttons
let buttonsDOM = [];
...
class UI {
  ...
  populateCart(cart) {
    ...
    cartLeft.addEventListener("click", () => {
      this.hideCart();
    });
  }
  //--------------------------------------------------------------------------------
